...
TechHub - это современный REST API для интернет-магазина электроники, построенный на асинхронном стеке технологий. Проект специализируется на продаже продукции ведущих брендов: **Apple, Samsung, Xiaomi, Google** и других.
